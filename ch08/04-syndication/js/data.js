...
(function () {
  ...
  feeds.forEach(function (feed) {
    ...
    var promise = syn.retrieveFeedAsync(url);
  ...
  function downloadError(error) {
    var feed = this;
    Debug.writeln("error: feed=" + feed.title + ", error= " + error.number + ": " + error.message);
  }

  function downloadProgress(request) {
    var feed = this;
    Debug.writeln("progress: feed= " + feed.title + ", bytesRetrieved= " + request.bytesRetrieved + ", totalBytesToRetrieve= " + request.totalBytesToRetrieve);
  }
